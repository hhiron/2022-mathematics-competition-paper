...
void dfs_bed(int cnt,int lim,int beg,int pos){//卧室的搜索 
	if(cnt>lim){
		bedcnt++;
		for(int i=1;i<=lim;i++){
...
void dfs_liv(int cnt,int lim,int beg,int pos){//客厅的搜索 
	if(cnt>lim){
		livcnt++;
		for(int i=1;i<=lim;i++){
...
void dfs_stu(int cnt,int lim,int beg,int pos){//书房的搜索 
	if(cnt>lim){
		stucnt++;
		for(int i=1;i<=lim;i++){
...
void dfs_din(int cnt,int lim,int beg,int pos){//餐厅的搜索 
	if(cnt>lim){
		dincnt++;
		for(int i=1;i<=lim;i++){
